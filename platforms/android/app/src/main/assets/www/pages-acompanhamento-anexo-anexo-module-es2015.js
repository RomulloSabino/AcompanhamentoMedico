...
let AnexoPageRoutingModule = class AnexoPageRoutingModule {
};
...
let AnexoPageModule = class AnexoPageModule {
};
...
let AnexoPage = class AnexoPage {
    constructor(router, formBuilder, navCtrl, toast, atrCtrl, modalCtrl, camera, chooser, storageService) {
        this.router = router;
    ...
    upload() {
        this.chooser.getFile("image/jpeg,image/gif,image/jpg,image/png").then((value) => {
    ...
    salvarAnexo() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.storageService.atualizar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_13__["default"].STORAGE_ACOMPANHAMENTO_MEDICO, this.acompanhamentoMedico, "senhaAutorizacao.senha");
                ...
                buttons: [
                    {
                        ...
                        text: 'Confirmar',
                        handler: () => {
                            this.acompanhamentoMedico.listaAcompanhamentoObs.forEach((item, indice) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                                if (indice == index) {
...
//# sourceMappingURL=pages-acompanhamento-anexo-anexo-module-es2015.js.map