...
let ConfiguracoesGeraisPageRoutingModule = class ConfiguracoesGeraisPageRoutingModule {
};
...
let ConfiguracoesGeraisPageModule = class ConfiguracoesGeraisPageModule {
};
...
module.exports = ".button-large {\n  font-size: 14px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let ConfiguracoesGeraisPage = class ConfiguracoesGeraisPage {
    constructor(router, atrCtrl, toastCrl, loading, popover, parametrosService, storageService, prestadorService, acompanhamentoService) {
        this.router = router;
    ...
    confirmarAtualizarMotivoAlta() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_6__["DominioCodigo"];
            ...
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_MOTIVO_SAIDA);
            yield this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                ...
                for (let motivo of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_MOTIVO_SAIDA, motivo);
                }
                loading.dismiss();
    ...
    confirmarAtualizarTipoAcomodacao() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_6__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Tipos de Acomodação...');
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_TIPO_ACOMODACAO);
            yield this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let acomodacao of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_TIPO_ACOMODACAO, acomodacao);
                }
                loading.dismiss();
    ...
    abirTelaExcluirAcompanhamentosEncerrados() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    confirmarAtualizarPosologia() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Posologias...');
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_POSOLOGIA);
            yield this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let posologia of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_POSOLOGIA, posologia);
                }
                loading.dismiss();
    ...
    confirmarAtualizarItensPrincipais() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            const loading = yield this.loading.presentLoading('Buscando Itens...');
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ITENS_PRINCIPAIS);
            yield this.parametrosService.getListaItemPrincipal(operadora.codOperadora).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let item of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ITENS_PRINCIPAIS, item);
                }
                loading.dismiss();
    ...
    confirmarAtualizarUF() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            const loading = yield this.loading.presentLoading('Buscando UFs...');
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_UF);
            yield this.prestadorService.getUFPrestadores(operadora).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let uf of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_UF, uf);
                }
                loading.dismiss();
    ...
    enviarAcompanhamentosEmail() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let listaAcompanhamentos;
            this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ACOMPANHAMENTO_MEDICO).then((itens) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                if (itens) {
                    const loading = yield this.loading.presentLoading('Enviando...');
                    listaAcompanhamentos = itens;
                    yield this.acompanhamentoService.enviarAcompanhamentosEmail(listaAcompanhamentos, this.usuario.login).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                        loading.dismiss();
                        if (data) {
    ...
    confirmarAtualizarTipoInternacao() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_6__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Tipos de Internação...');
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_TIPO_INTERNACAO);
            yield this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let internacao of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_TIPO_INTERNACAO, internacao);
                }
                loading.dismiss();
    ...
    confirmarAtualizarCaraterAtendimento() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_6__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Tipos de Internação...');
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_CARATER_ATENDIMENTO);
            yield this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let carater of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_CARATER_ATENDIMENTO, carater);
                }
                loading.dismiss();
    ...
    confirmarAtualizarOrigemInternacao() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_5__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_6__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            yield this.storageService.apagarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ORIGEM_INTERNACAO);
            yield this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                //Atualiza a lista no dispositivo         
                for (let origem of data) {
                    yield this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ORIGEM_INTERNACAO, origem);
                }
                loading.dismiss();
...
ConfiguracoesGeraisPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-configuracao-configuracoes-gerais-configuracoes-gerais-module-es2015.js.map