...
var ListarAcompanhamentoPageRoutingModule = /** @class */ (function () {
    function ListarAcompanhamentoPageRoutingModule() {
    }
    ...
    return ListarAcompanhamentoPageRoutingModule;
}());
...
var ListarAcompanhamentoPageModule = /** @class */ (function () {
    function ListarAcompanhamentoPageModule() {
    }
    ...
    return ListarAcompanhamentoPageModule;
}());
...
module.exports = "ion-card-header {\n  padding: 0px;\n}\n\n.card-conteudo {\n  padding: 8px;\n}\n\n.texto-card-label {\n  font-size: 12px;\n  color: var(--ion-color-primary);\n  font-weight: bold;\n}\n\n.texto-card-text {\n  font-size: 11px;\n  color: var(--ion-color-primary);\n}\n\n.texto-card-text-red {\n  font-size: 11px;\n  color: var(--ion-color-danger);\n  font-weight: bold;\n}\n\n.texto-card-text-yellow {\n  font-size: 11px;\n  color: var(--ion-color-warning);\n  font-weight: bold;\n}\n\n.texto-card-text-green {\n  font-size: 11px;\n  color: var(--ion-color-success);\n  font-weight: bold;\n}\n\n.alert-message.sc-ion-alert-md {\n  font-size: 14px;\n}\n\n.sc-ion-card-ios-h {\n  margin-top: 4px;\n}\n\n.list-ios {\n  margin-top: 0px;\n  margin-bottom: 0px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListarAcompanhamentoPage = /** @class */ (function () {
    function ListarAcompanhamentoPage(router, navCtrl, atrCtrl, toast, acompanhamentoService, storageService, networkService) {
        this.router = router;
    ...
    ListarAcompanhamentoPage.prototype.ngOnInit = function () {
        moment__WEBPACK_IMPORTED_MODULE_4__["locale"]('pt-br');
        this.flgMarcarTodos = false;
        this.recuperarDados();
    };
    ListarAcompanhamentoPage.prototype.recuperarDados = function () {
    ...
    ListarAcompanhamentoPage.prototype.filtrarLista = function (event) {
        var _this = this;
        this.filtroLista = event.target.value.toLowerCase();
        this.listaAcompanhamentosFiltrados = this.listaAcompanhamentos;
        this.listaAcompanhamentosFiltrados = this.listaAcompanhamentosFiltrados.filter(function (item) {
            return item.concatDadosAcompanhamentoFiltro.toLowerCase().includes(_this.filtroLista);
        });
    };
    ListarAcompanhamentoPage.prototype.cancelaFiltroLista = function () {
        this.filtroLista = '';
        this.listaAcompanhamentosFiltrados = this.listaAcompanhamentos;
    };
    ListarAcompanhamentoPage.prototype.confirmarImportarAcompanhamento = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var importar, _i, _a, acompanhamento, mensagem, alert_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        importar = false;
                        for (_i = 0, _a = this.listaAcompanhamentosFiltrados; _i < _a.length; _i++) {
                        ...
                        if (!importar) return [3 /*break*/, 4];
                        mensagem = "Os acompanhamento médicos marcados serão importados.";
    ...
    ListarAcompanhamentoPage.prototype.importarAcompanhamento = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var usuario, _i, _a, acompanhamento;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _i = 0, _a = this.listaAcompanhamentosFiltrados;
                        _b.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 6];
                        acompanhamento = _a[_i];
                        if (!acompanhamento.flgImportar) return [3 /*break*/, 5];
                        ...
                        if (!acompanhamento.flgExisteDispositivo) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.storageService.atualizar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_6__["default"].STORAGE_ACOMPANHAMENTO_MEDICO, acompanhamento, "senhaAutorizacao.senha")];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.storageService.adicionar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_6__["default"].STORAGE_ACOMPANHAMENTO_MEDICO, acompanhamento)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
    ...
    ListarAcompanhamentoPage.prototype.verificaExisteDispositivo = function (listaAcompanhamentos) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var acompanhamentoDispositivo, listaDispositivo, _loop_1, _i, listaAcompanhamentos_1, acomp;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listaDispositivo = [];
                        return [4 /*yield*/, this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_6__["default"].STORAGE_ACOMPANHAMENTO_MEDICO).then(function (items) {
                                if (items != null) {
                    ...
                    case 1:
                        _a.sent();
                        _loop_1 = function (acomp) {
                            acompanhamentoDispositivo = listaDispositivo.find(function (x) { return x.senhaAutorizacao.senha === acomp.senhaAutorizacao.senha &&
                        ...
                        for (_i = 0, listaAcompanhamentos_1 = listaAcompanhamentos; _i < listaAcompanhamentos_1.length; _i++) {
                            acomp = listaAcompanhamentos_1[_i];
                            _loop_1(acomp);
                        }
                        return [2 /*return*/];
                }
    ...
    ListarAcompanhamentoPage.prototype.marcarDesmarcarTodos = function () {
        this.flgMarcarTodos = !this.flgMarcarTodos;
        for (var _i = 0, _a = this.listaAcompanhamentosFiltrados; _i < _a.length; _i++) {
            var acompanhamento = _a[_i];
            acompanhamento.flgImportar = this.flgMarcarTodos;
        }
    };
    ListarAcompanhamentoPage.ctorParameters = function () { return [
    ...
    return ListarAcompanhamentoPage;
}());
...
//# sourceMappingURL=pages-importar-listar-acompanhamento-listar-acompanhamento-module-es5.js.map