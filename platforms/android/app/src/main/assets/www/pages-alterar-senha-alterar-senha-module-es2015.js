...
class RxFormGroup extends _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"] {
    ...
    valueChangedSync() {
        Object.keys(this.controls).forEach(columnName => {
            if (!(this.controls[columnName] instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormArray"] || this.controls[columnName] instanceof RxFormArray) && !(this.controls[columnName] instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"] || this.controls[columnName] instanceof RxFormGroup) && !(this.entityObject[columnName] instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"] || this.entityObject[columnName] instanceof RxFormControl) && this.controls[columnName].getControlValue && ApplicationUtil.notEqualTo(this.controls[columnName].getControlValue(), this.entityObject[columnName])) {
    ...
    setBackEndErrors(errors) {
        Object.keys(errors).forEach(controlName => {
            if (this.controls[controlName]) {
                if (this.controls[controlName] instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"])
...
let AlterarSenhaPage = class AlterarSenhaPage {
    constructor(formBuilder, toast, loading, loginService, navCtrl, storageService) {
    ...
    toFieldNovaSenha(inputNovaSenha) {
        inputNovaSenha.setFocus();
    }
    toFieldRepetirNovaSenha(inputRepetirNovaSenha) {
    ...
    alterarSenha() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const loading = yield this.loading.presentLoading();
            this.loginService.alterarSenha(usuario).subscribe((usuario) => {
                ...
                this.storageService.atualizar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_10__["default"].STORAGE_USUARIO, dadosUsuario, "idUsuario");
...
//# sourceMappingURL=pages-alterar-senha-alterar-senha-module-es2015.js.map