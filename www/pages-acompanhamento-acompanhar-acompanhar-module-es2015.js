...
let AcompanharPageRoutingModule = class AcompanharPageRoutingModule {
};
...
let AcompanharPageModule = class AcompanharPageModule {
};
...
let AcompanharPage = class AcompanharPage {
    constructor(formBuilder, loading, toast, storageService, router, atrCtrl, modalCtrl) {
    ...
    buscarPrestadoresComAcompanhamento() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ACOMPANHAMENTO_MEDICO).then(itens => {
                if (itens) {
                    itens.forEach(acomp => {
    ...
    abrirAcompanhamento(acompanhamentoMedico) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                        ...
                        handler: () => {
                            this.listaAcompanhamentos.forEach((item, indice) => {
                                if (indice == index) {
                                    ...
                                    this.storageService.apagar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ACOMPANHAMENTO_MEDICO, item, "senhaAutorizacao.senha");
                                }
                            });
                        }
                    }]
...
//# sourceMappingURL=pages-acompanhamento-acompanhar-acompanhar-module-es2015.js.map