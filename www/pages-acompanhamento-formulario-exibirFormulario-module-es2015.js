...
let ExibirFormularioPageRoutingModule = class ExibirFormularioPageRoutingModule {
};
...
let ExibirFormularioPageModule = class ExibirFormularioPageModule {
};
...
module.exports = ".ion-item-sliding {\n  display: block;\n  position: relative;\n  width: 95%;\n  overflow: hidden;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.ion-margin-bottom, [margin-bottom] {\n  margin-bottom: var(--ion-margin, 16px);\n  margin-bottom: var(--ion-margin, 2px);\n}\n\nion-item-options ion-button {\n  height: auto;\n}\n\nion-item-sliding ion-item {\n  --inner-border-width: 0 0 0px 0;\n  --border-width: 1px 1px 1px;\n  --border-radius: 10px;\n  --border-color:var(--ion-color-secondary-shade);\n  -webkit-margin-before: 2px;\n          margin-block-start: 2px;\n  -webkit-margin-after: 5px;\n          margin-block-end: 5px;\n}\n\nion-select {\n  margin-top: 10px;\n  margin-bottom: 5px;\n  background-color: var(--ion-color-light-tint);\n}\n\nion-datetime {\n  margin-top: 30px;\n  margin-bottom: 5px;\n  background-color: var(--ion-color-light-tint);\n  opacity: unset;\n}\n\n.item-has-focus.label-floating.sc-ion-label-md-h, .item-has-focus .label-floating.sc-ion-label-md-h, .item-has-placeholder.label-floating.sc-ion-label-md-h, .item-has-placeholder .label-floating.sc-ion-label-md-h, .item-has-value.label-floating.sc-ion-label-md-h, .item-has-value .label-floating.sc-ion-label-md-h {\n  font-size: 22px;\n}\n\n.item-has-focus.label-floating.sc-ion-label-ios-h, .item-has-focus .label-floating.sc-ion-label-ios-h, .item-has-placeholder.label-floating.sc-ion-label-ios-h, .item-has-placeholder .label-floating.sc-ion-label-ios-h, .item-has-value.label-floating.sc-ion-label-ios-h, .item-has-value .label-floating.sc-ion-label-ios-h {\n  font-size: 22px;\n  -webkit-transform: none;\n          transform: none;\n}\n\n.label-floating.sc-ion-label-ios-h {\n  font-size: 22px;\n}\n\n.textarea-margin-background {\n  margin-top: 30px;\n  margin-bottom: 5px;\n  background-color: var(--ion-color-light-tint);\n}\n\n.iconCalendar {\n  margin-top: auto;\n}\n\nion-input {\n  margin-top: 30px;\n  margin-bottom: 5px;\n  background-color: var(--ion-color-light-tint);\n  opacity: unset;\n  font-weight: 100;\n}\n\n.label-size18-left10 {\n  font-size: 18px;\n  margin-left: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let ExibirFormularioPage = class ExibirFormularioPage {
    ...
    buscaTipoAcomodacao() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.networkService.CheckNetworkStatus();
            if (this.networkService.NetworkStatus.value) {
                yield this.buscaTipoAcomodacaoOnline();
            }
            else {
                yield this.buscaTipoAcomodacaoOffline();
            }
        });
    }
    buscaTipoAcomodacaoOnline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_9__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Acomodação...');
            this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => {
    ...
    buscaTipoAcomodacaoOffline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const loading = yield this.loading.presentLoading('Buscando Acomodação...');
            this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_11__["default"].STORAGE_TIPO_ACOMODACAO).then(items => {
                if (items != null) {
    ...
    buscaTipoInternacao() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.networkService.CheckNetworkStatus();
            if (this.networkService.NetworkStatus.value) {
                yield this.buscaTipoInternacaoOnline();
            }
            else {
                yield this.buscaTipoInternacaoOffline();
            }
        });
    }
    buscaTipoInternacaoOnline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_9__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Tipo de Internação...');
            this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => {
    ...
    buscaTipoInternacaoOffline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const loading = yield this.loading.presentLoading('Buscando Tipo de Internação...');
            this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_11__["default"].STORAGE_TIPO_INTERNACAO).then(items => {
                if (items != null) {
    ...
    buscaCaraterAtendimento() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.networkService.CheckNetworkStatus();
            if (this.networkService.NetworkStatus.value) {
                yield this.buscaCaraterAtendimentoOnline();
            }
            else {
                yield this.buscaCaraterAtendimentoOffline();
            }
        });
    }
    buscaCaraterAtendimentoOnline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_9__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Caráter do Atendimento...');
            this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => {
    ...
    buscaCaraterAtendimentoOffline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const loading = yield this.loading.presentLoading('Buscando Caráter do Atendimento...');
            this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_11__["default"].STORAGE_CARATER_ATENDIMENTO).then(items => {
                if (items != null) {
    ...
    buscaOrigemInternacao() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.networkService.CheckNetworkStatus();
            if (this.networkService.NetworkStatus.value) {
                yield this.buscaOrigemInternacaoOnline();
            }
            else {
                yield this.buscaOrigemInternacaoOffline();
            }
        });
    }
    buscaOrigemInternacaoOnline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let operadora = new src_app_model_Operadora_model__WEBPACK_IMPORTED_MODULE_9__["Operadora"];
            let dominioCodigo = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"];
            operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:dadosOperadora'));
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Buscando Origem Internação...');
            this.parametrosService.getListaDominioCodigo(dominioCodigo).subscribe((data) => {
    ...
    buscaOrigemInternacaoOffline() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const loading = yield this.loading.presentLoading('Buscando Origem Internação...');
            this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_11__["default"].STORAGE_ORIGEM_INTERNACAO).then(items => {
                if (items != null) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.justificativa.valid || !this.dataInternacao.valid || !this.horaInternacao.valid || this.tipoAcomodacao.value == "" ||
                ...
                if (this.diaAcompanhamento.valid) {
                    ...
                    let dataInternacao = new Date(moment__WEBPACK_IMPORTED_MODULE_2__(this.dataInternacao.value, "DD/MM/YYYY").toISOString());
                ...
                let tipoAcomodacao = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"]();
                tipoAcomodacao.seqDominio = this.tipoAcomodacao.value;
                this.acompanhamentoMedico.tipoAcomodacao = tipoAcomodacao;
                let tipoInternacao = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"]();
                tipoInternacao.seqDominio = this.tipoInternacao.value;
                this.acompanhamentoMedico.tipoInternacao = tipoInternacao;
                let caraterAtendimento = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"]();
                ...
                let origemInternacao = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"]();
    ...
    atualizaCampos() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.horaInternacao.valid) {
                let hora = moment__WEBPACK_IMPORTED_MODULE_2__(this.horaInternacao.value, 'hh:mm a').format('HH:mm');
            ...
            let cidDiagnostico = new src_app_model_DominioCodigo_model__WEBPACK_IMPORTED_MODULE_10__["DominioCodigo"]();
            if (this.cidDiagnostico.valid) {
                this.formAcompanhamento.get('cidDiagnostico').setValue(this.cidDiagnostico.value.trim());
                this.networkService.CheckNetworkStatus();
                if (this.networkService.NetworkStatus.value) {
                    yield this.validarCid();
                }
                else {
    ...
    validarCid() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            dominioCodigo.operadora = operadora;
            const loading = yield this.loading.presentLoading('Validando CID...');
            this.parametrosService.getVerificaDominioCodigo(dominioCodigo).subscribe((data) => {
...
ExibirFormularioPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-acompanhamento-formulario-exibirFormulario-module-es2015.js.map