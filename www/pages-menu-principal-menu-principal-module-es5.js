...
var MenuPrincipalPageRoutingModule = /** @class */ (function () {
    function MenuPrincipalPageRoutingModule() {
    }
...
var MenuPrincipalPageModule = /** @class */ (function () {
    function MenuPrincipalPageModule() {
    }
...
var MenuPrincipalPage = /** @class */ (function () {
    function MenuPrincipalPage(menu, loading, atrCtrl, router, toast, storageService, verificaVersao) {
        this.menu = menu;
    ...
    MenuPrincipalPage.prototype.ngOnInit = function () {
        ...
        var operadora = JSON.parse(localStorage.getItem('@appAcompanhamentoMedico:operadoraUsuario'));
        if (operadora) {
    ...
    MenuPrincipalPage.prototype.verificaAcompanhamentoSincronizar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var flgPossuiAcompSincronizar;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                flgPossuiAcompSincronizar = false;
                this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ACOMPANHAMENTO_MEDICO).then(function (items) {
                    if (items != null) {
                        var listaAcompanhamentos = items;
                        for (var _i = 0, listaAcompanhamentos_1 = listaAcompanhamentos; _i < listaAcompanhamentos_1.length; _i++) {
                            var acomp = listaAcompanhamentos_1[_i];
                            if (acomp.usuario.login === _this.usuarioLogado.login &&
                                acomp.operadora.codOperadora === _this.usuarioLogado.operadora.codOperadora) {
                                if (acomp.listaAcompanhamentoDia && acomp.listaAcompanhamentoDia.length > 0) {
                                    var diaAcompanhamento = acomp.listaAcompanhamentoDia.find(function (y) { return y.statusSincronismo === src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STATUS_PENDENTE; });
                        ...
                        if (flgPossuiAcompSincronizar) {
                            _this.informaAcompanhamentoSincronizar();
                        }
                    }
                }, function (error) {
    ...
    MenuPrincipalPage.prototype.informaAcompanhamentoSincronizar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var mensagem, alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mensagem = "Você possui acompanhamento(s) para sincronizar. Por favor, sincronize seu(s) acompanhamento(s).";
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () {
                                            _this.router.navigateByUrl('menu-principal/sincronizar');
                                        }
                                    }
                                ]
                            })];
    ...
    MenuPrincipalPage.prototype.limparAcompanhamentosEncerrados = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.storageService.buscarTodos(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ACOMPANHAMENTO_MEDICO).then(function (items) {
                    if (items != null) {
                        var listaAcompanhamentos = items;
                        for (var _i = 0, listaAcompanhamentos_2 = listaAcompanhamentos; _i < listaAcompanhamentos_2.length; _i++) {
                            var acomp = listaAcompanhamentos_2[_i];
                            if (acomp.statusSincronismo === src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STATUS_SINCRONIZADO &&
                                ...
                                acomp.usuario.login === _this.usuarioLogado.login) {
                                var dataAtual = moment__WEBPACK_IMPORTED_MODULE_9__(new Date());
                                var dataEncerramento = new Date(moment__WEBPACK_IMPORTED_MODULE_9__(acomp.dataEncerramento, "DD/MM/YYYY").toISOString());
                                var qtdDiasEncerrado = dataAtual.diff(dataEncerramento, 'days');
                                if (qtdDiasEncerrado >= src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].QTD_DIAS_APAGAR_ENCERRADO) {
                                    _this.storageService.apagar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_7__["default"].STORAGE_ACOMPANHAMENTO_MEDICO, acomp, "senhaAutorizacao.senha");
                                }
                            }
                        }
                    }
    ...
    MenuPrincipalPage.ctorParameters = function () { return [
