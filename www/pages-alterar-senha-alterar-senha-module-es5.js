(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-alterar-senha-alterar-senha-module"],{
...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/alterar-senha/alterar-senha.page.html":
/*!***************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/alterar-senha/alterar-senha.page.html ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<ion-header>\r\n  <ion-toolbar class=\"ion-text-center\">\r\n    <ion-buttons slot=\"start\">\r\n      <ion-back-button defaultHref=\"/menu-principal\" text=\"\"></ion-back-button>\r\n    </ion-buttons>\r\n    <ion-buttons slot=\"end\">\r\n      <ion-menu-button menuId=\"main-content\"></ion-menu-button>\r\n    </ion-buttons>\r\n    <ion-title class=\"ion-text-uppercase\">Alterar Senha</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content class=\"ion-padding\">\r\n  <ion-grid class=\"ion-no-padding\" fixed>\r\n    <ion-row class=\"ion-margin ion-align-items-center ion-justify-content-center\">\r\n      <ion-col size-sm=\"8\" size-md=\"8\" size-lg=\"6\" size-xl=\"6\" class=\"ion-no-padding ion-text-center ion-no-margin\">\r\n        <form [formGroup]=\"formAlterarSenha\" (submit)=\"alterarSenha()\">\r\n\r\n          <ion-item>\r\n            <ion-icon slot=\"start\" name=\"lock\" color=\"primary\"></ion-icon>\r\n            <ion-label position=\"floating\">Senha Atual</ion-label>\r\n            <ion-input type=\"{{passwordType}}\" formControlName=\"senhaAtual\" enterkeyhint=\"next\"\r\n              (keyup.enter)=\"toFieldNovaSenha(inputNovaSenha)\"></ion-input>\r\n            <ion-icon slot=\"end\" name=\"{{iconPassword}}\" [ngStyle]=\"{'color': btnColorPassword}\"\r\n              (mousedown)=\"$event.preventDefault(); showHidePassword('senhaAtual')\" #inputSenhaAtual>\r\n            </ion-icon>\r\n          </ion-item>\r\n          <ion-item mode=\"md\" lines=\"none\" class=\"item-error\">\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(senhaAtual.dirty || senhaAtual.touched) && senhaAtual.hasError('required')\">Campo obrigatório\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(senhaAtual.dirty || senhaAtual.touched) && senhaAtual.hasError('minlength')\">Min 4 caracteres\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(senhaAtual.dirty || senhaAtual.touched) && senhaAtual.hasError('maxlength')\">Max 28 caracteres\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n          </ion-item>\r\n\r\n          <ion-item>\r\n            <ion-icon slot=\"start\" name=\"lock\" color=\"primary\"></ion-icon>\r\n            <ion-label position=\"floating\">Nova Senha</ion-label>\r\n            <ion-input type=\"{{newPasswordType}}\" formControlName=\"novaSenha\" enterkeyhint=\"next\"\r\n              (keyup.enter)=\"toFieldRepetirNovaSenha(inputRepetirNovaSenha)\" #inputNovaSenha></ion-input>\r\n            <ion-icon slot=\"end\" name=\"{{iconNewPassword}}\" [ngStyle]=\"{'color': btnColorNewPassword}\"\r\n              (mousedown)=\"$event.preventDefault(); showHidePassword('novaSenha')\">\r\n            </ion-icon>\r\n          </ion-item>\r\n          <ion-item mode=\"md\" lines=\"none\" class=\"item-error\">\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(novaSenha.dirty || novaSenha.touched) && novaSenha.hasError('required')\">Campo obrigatório\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(novaSenha.dirty || novaSenha.touched) && novaSenha.hasError('minlength')\">Min 4 caracteres\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(novaSenha.dirty || novaSenha.touched) && novaSenha.hasError('maxlength')\">Max 28 caracteres\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n          </ion-item>\r\n\r\n          <ion-item>\r\n            <ion-icon slot=\"start\" name=\"lock\" color=\"primary\"></ion-icon>\r\n            <ion-label position=\"floating\">Confirme a Nova Senha</ion-label>\r\n            <ion-input type=\"{{confirmNewPasswordType}}\" formControlName=\"confirmarNovaSenha\" enterkeyhint=\"go\"\r\n              (keyup.enter)=\"alterarSenha()\" #inputRepetirNovaSenha>\r\n            </ion-input>\r\n            <ion-icon slot=\"end\" name=\"{{iconConfirmNewPassword}}\" [ngStyle]=\"{'color': btnColorConfirmNewPassword}\"\r\n              (mousedown)=\"$event.preventDefault(); showHidePassword('confirmarNovaSenha')\">\r\n            </ion-icon>\r\n          </ion-item>\r\n          <ion-item mode=\"md\" lines=\"none\" class=\"item-error\">\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(confirmarNovaSenha.dirty || confirmarNovaSenha.touched) && confirmarNovaSenha.hasError('required')\">\r\n              Campo\r\n              obrigatório\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"(confirmarNovaSenha.dirty || confirmarNovaSenha.touched) && confirmarNovaSenha.hasError('minlength')\">\r\n              Min 4\r\n              caracteres\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\"\r\n              *ngIf=\"(confirmarNovaSenha.dirty || confirmarNovaSenha.touched) && confirmarNovaSenha.hasError('maxlength')\">\r\n              Max\r\n              28\r\n              caracteres\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n            <ion-note color=\"warning\" class=\"ion-padding-horizontal\"\r\n              *ngIf=\"confirmarNovaSenha.dirty && confirmarNovaSenha.hasError('compare')\">\r\n              As senhas não coincidem\r\n              <ion-icon color=\"warning\" class=\"margin-top-02em\" name=\"alert\"></ion-icon>\r\n            </ion-note>\r\n          </ion-item>\r\n\r\n          <ion-button class=\"ion-margin-top\" type=\"submit\" expand=\"block\" size=\"large\"\r\n            [disabled]=\"!formAlterarSenha.valid\">\r\n            ALTERAR\r\n          </ion-button>\r\n        </form>"

/***/ }),

/***/ "./src/app/pages/alterar-senha/alterar-senha-routing.module.ts":
/*!*********************************************************************!*\
  !*** ./src/app/pages/alterar-senha/alterar-senha-routing.module.ts ***!
  \*********************************************************************/
/*! exports provided: AlterarSenhaPageRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AlterarSenhaPageRoutingModule", function() { return AlterarSenhaPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _alterar_senha_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./alterar-senha.page */ "./src/app/pages/alterar-senha/alterar-senha.page.ts");
...
var routes = [
    {
        path: '',
        component: _alterar_senha_page__WEBPACK_IMPORTED_MODULE_3__["AlterarSenhaPage"]
    }
];
var AlterarSenhaPageRoutingModule = /** @class */ (function () {
    function AlterarSenhaPageRoutingModule() {
    }
    AlterarSenhaPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
        })
    ], AlterarSenhaPageRoutingModule);
    return AlterarSenhaPageRoutingModule;
}());
...
/***/ "./src/app/pages/alterar-senha/alterar-senha.module.ts":
/*!*************************************************************!*\
  !*** ./src/app/pages/alterar-senha/alterar-senha.module.ts ***!
  \*************************************************************/
/*! exports provided: AlterarSenhaPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _alterar_senha_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./alterar-senha-routing.module */ "./src/app/pages/alterar-senha/alterar-senha-routing.module.ts");
/* harmony import */ var _alterar_senha_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./alterar-senha.page */ "./src/app/pages/alterar-senha/alterar-senha.page.ts");
...
var AlterarSenhaPageModule = /** @class */ (function () {
    ...
    AlterarSenhaPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
                _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
                _alterar_senha_routing_module__WEBPACK_IMPORTED_MODULE_5__["AlterarSenhaPageRoutingModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]
            ],
            declarations: [_alterar_senha_page__WEBPACK_IMPORTED_MODULE_6__["AlterarSenhaPage"]]
        })
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2FsdGVyYXItc2VuaGEvYWx0ZXJhci1zZW5oYS5wYWdlLnNjc3MifQ== */"
...
/*!***********************************************************!*\
  !*** ./src/app/pages/alterar-senha/alterar-senha.page.ts ***!
  \***********************************************************/
/*! exports provided: AlterarSenhaPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AlterarSenhaPage", function() { return AlterarSenhaPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var AlterarSenhaPage = /** @class */ (function () {
    function AlterarSenhaPage(formBuilder, toast, loading, loginService, navCtrl, storageService) {
        ...
        this.iconNewPassword = "eye-off";
        this.iconConfirmNewPassword = "eye-off";
        this.btnColorPassword = "#a8c4c4";
        this.btnColorNewPassword = "#a8c4c4";
        this.btnColorConfirmNewPassword = "#a8c4c4";
    }
    AlterarSenhaPage.prototype.ngOnInit = function () {
        this.criarFormulario();
    };
    Object.defineProperty(AlterarSenhaPage.prototype, "senhaAtual", {
        get: function () {
    ...
    Object.defineProperty(AlterarSenhaPage.prototype, "novaSenha", {
        get: function () {
    ...
    Object.defineProperty(AlterarSenhaPage.prototype, "confirmarNovaSenha", {
        get: function () {
    ...
    AlterarSenhaPage.prototype.criarFormulario = function () {
        this.formAlterarSenha = this.formBuilder.group({
            senhaAtual: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(4),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(28)
                ])],
            novaSenha: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(4),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(28)
                ])],
            confirmarNovaSenha: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(4),
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(28),
                    _rxweb_reactive_form_validators__WEBPACK_IMPORTED_MODULE_7__["RxwebValidators"].compare({ fieldName: 'novaSenha' })
                ])],
        });
    };
    AlterarSenhaPage.prototype.toFieldNovaSenha = function (inputNovaSenha) {
        inputNovaSenha.setFocus();
    };
    AlterarSenhaPage.prototype.toFieldRepetirNovaSenha = function (inputRepetirNovaSenha) {
        inputRepetirNovaSenha.setFocus();
    };
    AlterarSenhaPage.prototype.showHidePassword = function (type) {
        var _a = this.changePasswordType(type), passType = _a[0], icon = _a[1], buttonColor = _a[2];
    ...
    AlterarSenhaPage.prototype.changePasswordType = function (passType) {
    ...
    AlterarSenhaPage.prototype.alterarSenha = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var dadosUsuario, usuario, loading;
            var _this = this;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (usuario.senha === usuario.novaSenha) {
                            return [2 /*return*/, this.toast.infoToast('Digite uma senha diferente da atual.')];
                        }
                        return [4 /*yield*/, this.loading.presentLoading()];
                    case 1:
                        loading = _a.sent();
                        this.loginService.alterarSenha(usuario).subscribe(function (usuario) {
                            ...
                            _this.storageService.atualizar(src_app_config_constantes_constantes__WEBPACK_IMPORTED_MODULE_10__["default"].STORAGE_USUARIO, dadosUsuario, "idUsuario");
                            var mensagem = "Senha alterada com sucesso.";
                            loading.dismiss();
                            _this.toast.successToast(mensagem);
    ...
    AlterarSenhaPage.ctorParameters = function () { return [
    ...
    AlterarSenhaPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-alterar-senha',
            template: __webpack_require__(/*! raw-loader!./alterar-senha.page.html */ "./node_modules/raw-loader/index.js!./src/app/pages/alterar-senha/alterar-senha.page.html"),
            styles: [__webpack_require__(/*! ./alterar-senha.page.scss */ "./src/app/pages/alterar-senha/alterar-senha.page.scss")]
        }),
...
//# sourceMappingURL=pages-alterar-senha-alterar-senha-module-es5.js.map